...
export class ProductService {
  ...
  public findAll():Observable<any>{
    ...
    return this.httpClient.get(this.url+'findAllEnableY',{headers:headers});
  }
  ...
  public buscarProductos(busqueda:string):Observable<any>{
    let headers=this.createTokenHeader();
    return this.httpClient.get(this.url+'findBusqueda/'+busqueda,{headers:headers});
  }
